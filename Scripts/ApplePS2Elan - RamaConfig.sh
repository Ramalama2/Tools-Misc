...
Reboot_after_Install="NO"                                # YES or NO
...
v4HWHasPhysicalButtons="NO"  # YES or NO #Enable Physical Left/Right Buttons
...
KBacklight_has_16_Levels="YES"                  # YES or NO
IdleAsusKBlightAutoOff="YES"                    # YES or NO
...
KeyboardHas16BLightLvls="YES"                    # "YES" or "NO"
KBackLightlvlAtBoot="1"                       # 0-3 or 0-16 or -1=NVRAM
IdleKBacklightAutoOff="YES"                      # "YES" or "NO"
IdleKBacklightAutoOffTimeout="20"               # Timeout: Default=10 Secounds
